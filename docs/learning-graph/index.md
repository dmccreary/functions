# Learning Graph for IB Mathematics Functions
...
- Connectivity: all 208 concepts connected in a single graph
...
- 13 concept categories covering all IB Mathematics Functions topics
- Category organization - foundational elements first, modeling and applications last
- Balanced categories (4.3% - 13.0% each)
