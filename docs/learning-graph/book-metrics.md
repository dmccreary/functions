...
| Concepts | 208 | [Concept List](./concept-list.md) | Concepts from learning graph |
| Glossary Terms | 208 | [Glossary](../glossary.md) | Defined terms |
| FAQs | 85 | [FAQ](../faq.md) | Frequently asked questions |
...
|-------------|-------------|---------------|-------|
| Diagrams | 27 | 27 | H4 headers starting with '#### Diagram:' |
| Equations | 3937 | 2709 | LaTeX expressions (inline and display) |
| Total Words | 70,513 | 40,263 | Words in markdown files |
| Links | 225 | 33 | Hyperlinks in markdown format |
| Equivalent Pages | 303 | 182 | Estimated pages (250 words/page + visuals) |
