...
|---|---------|-------|--------|-------|
| 1 | Concepts | 208 | Required | Concepts from learning graph |
| 2 | Chapters | 13 | Required | Chapter directories with index.md |
| 3 | MicroSims | 29 | Recommended | Interactive simulations in docs/sims/ |
| 4 | Stories | 16 | Optional | Graphic-novel narratives in docs/stories/ |
| 5 | Chapter Quizzes | 13 / 13 | Recommended | Chapters with a quiz.md (130 questions total) |
| 6 | Chapter References | 0 / 13 | Recommended | Chapters with references.md (0 references total) |
| 7 | Glossary Terms | 208 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 85 | Recommended | Questions in faq.md |
| 9 | Words | 143,401 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 28 | 28 | H4 headers starting with '#### Diagram:' |
| Equations | 5322 | 4050 | LaTeX expressions (inline and display) |
| Total Words | 143,401 | 54,421 | Words in markdown files |
| Links | 367 | 33 | Hyperlinks in markdown format |
| Equivalent Pages | 595 | 239 | Estimated pages (250 words/page + visuals) |
