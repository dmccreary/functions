---
title: Rick Rendering Test
description: This test page shows all mascot images as well as the admonition styles for our pedagogical agent Rick
...
!!! mascot-neutral "A Note from Rick"
    <img src="../../img/mascot/neutral.png" class="mascot-admonition-img" alt="Rick notes">
    Here is a friendly note from Rick.

!!! mascot-welcome "Rick Welcomes You!"
    <img src="../../img/mascot/welcome.png" class="mascot-admonition-img" alt="Rick welcomes you">
    Welcome, friend!

!!! mascot-thinking "Rick Key Insight"
...
!!! mascot-warning "Rick Gentle Warning of Common Mistake"
...
!!! mascot-encourage "You've Got This!"
    <img src="../../img/mascot/encouraging.png" class="mascot-admonition-img" alt="Rick encourages you">
