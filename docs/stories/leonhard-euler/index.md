---
title: Leonhard Euler and the Symbol That Stuck
description: How a blind Swiss mathematician dictated more math from memory than anyone in history — and gave us the single most important notation in functions class: f(x).
image: /stories/leonhard-euler/cover.png
