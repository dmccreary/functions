...
description: Interactive p5.js MicroSim for coordinate plane explorer.
...
```html
<iframe src="https://dmccreary.github.io/functions/sims/coordinate-plane-explorer/main.html"
        height="450px"
        width="100%"
        scrolling="no"></iframe>
```
